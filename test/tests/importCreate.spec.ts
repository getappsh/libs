import { CREATE, GET_MAP, STATUS } from "@app/common/utils/paths";
import { SuperAgentTest } from "supertest";
import { getDeviceId, getDiscoveryData } from "./discovery.spec";
import { CreateImportResDto, ImportStatusResDto } from "@app/common/dto/map";
...
export const importCreateTest = async (request: SuperAgentTest) => {
  ...
  expect(statusRes).toBeValidWithClassValidator(ImportStatusResDto)
}
